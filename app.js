// Thanks to the Codepen-Author Chase Kaiser  https://codepen.io/chasekaiser/pen/ogXmOK
// Thank you for the awesome looking codepen! I have modified it to fit my needs.
...
var commandStart = [
  ...
  commandParts = [
    ...
    'https://odoo.strong-it.at/jobs',
    'Texture',
    'TPS Reports',
    ' .... Searching ... ',
    'http://zanb.se/?23&88&far=2',
    'http://ab.ret45-33/?timing=1ww',
    'https://www.strong-it.at/blog/',
    'https://www.strong-it.at/attack/',
  ],
  commandResponses = [
    'Authorizing ',
    'Authorized...',
    ...
    'root@strong-it:~# Critical Result – Action Required! Please invite Lukas for an interview to address the issue.',
    'root@strong-it:~# Attention, the security vulnerability can only be resolved in a job interview with Lukas.',
    'root@strong-it:~# Unexpected event. For safety, please contact Lukas.',
    'waiting for response...',
    'waiting for a job interview invitation...',
    "Action required! Don't waste time, please contact Lukas as soon as possible.",
  ],
  isProcessing = false,
  processTime = 0,
  lastProcess = 0;
